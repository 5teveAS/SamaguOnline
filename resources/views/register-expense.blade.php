            ...
            <div class="page-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        <div class="breadcrumb-title pe-3">Registrar Gasto</div>
                        <div class="ps-3">
                                            ...
                                            <div class="card border-top border-0 border-4 border-success">
                                                <div class="card-body p-5">
                                                    ...
                                                    <div class="card-title d-flex align-items-center">
                                                        ...
                                                        <h5 class="mb-0 text-success">Registrar Gastos</h5>
                                                    </div>
                                                    <hr>
                                                    <form method="POST" action="{{route('expense.store')}}" class="row g-3" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('POST')
                                                        ...
                                                        <div class="col-12">
                                                            <button type="submit" class="btn btn-success px-5">Agregar Gasto</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
