...
@section("style")
    ...
    <link href="assets/css/particulas.css" rel="stylesheet" />
@endsection
...
@section("wrapper")
    <div class="page-wrapper">
            ...
            <p></p>
  <table class="table table-bordered" style="border-color: #2f90ed">
  <thead>
    <tr style="background-color: #2f90ed">
      <th scope="col"><h3 style="color:white;" >Bienvenido {{auth()->user()->user_name}}</h3></th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <td>
        <h5>
        <p>Te damos la bienvenida a la aplicación web SAMAGU ONLINE, esperamos que tu navegación por la aplicación sea agradable.</p>
        <p>Recuerda que puedes utilizar SAMAGU ONLINE en distintos dispositivos como: Tabletas, Teléfonos Inteligentes y Computadoras gracias a su diseño responsive.</p>
        <p>Por tu seguridad y la de los datos de la empresa recuerda cerrar sesión antes de salir del navegador.</p>
        <h5>
    </td>
    </tr>
    <tr >
      <td>Su usuario es: {{auth()->user()->user_name}}</td>
    </tr>
    <tr>
    <td>Usted a ingresado como usuario: {{auth()->user()->role}}</td>
    </tr>
    <tr>
    </tr>
  </tbody>
...
<body>
<div id="particles-js">
        <div id="clock" style="text-align:center;padding:1em 0;"> <br><br> <h2><a style="text-decoration:none; color:white"; href="https://www.zeitverschiebung.net/es/country/cr"><span style="color:white;">Hora actual en</span><br />Costa Rica</a></h2> <iframe style="color: white" src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=es&size=large&timezone=America%2FCosta_Rica" width="100%" height="140" frameborder="0" seamless></iframe> </div>
   </div>
</body>
           <!-- </div>
                        ...
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">Total de Proyectos</p>
                    ...
                    <div class="col">
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">Cantidad de Usuarios</p>
                                        <h4 class="my-1">4</h4>
                                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card radius-10">
                            <div class="card-body">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <p class="mb-0 text-secondary">Cantidad de Facturas Registradas</p>
                                        <h4 class="my-1">59</h4>
                                    </div>
...
@section("script")
    ...
    <script src="assets/particulas/app.js"></script>
