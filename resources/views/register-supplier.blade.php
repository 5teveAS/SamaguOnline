            ...
            <div class="page-wrapper">
                <div class="page-content">
                    ...
                    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        <div class="breadcrumb-title pe-3">Registrar Proveedor</div>
                        <div class="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 p-0">
                                    <li class="breadcrumb-item"><a href="{{ route('supplier.datatable') }}"><i class="bx bx-home-alt"></i></a>
                                    </li>
                            ...
                            <div class="card border-top border-0 border-4 border-success">
                                <div class="card-body p-5">
                                    <div class="card-title d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 text-success">Registrar Proveedor</h5>
                                    </div>
                                    <hr>
                                    <form method="POST" action="{{route('supplier.store')}}" class="row g-3" enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <label for="companyName" class="form-label"><span class="required">* </span>Nombre de la empresa</label>
                                            <input type="text"
                                                   class="form-control"
                                                   name="company_name"
                                                   id="companyName"
                                        ...
                                        <div class="col-12">
                                            <button type="submit" class="btn btn-success px-5">Agregar Proveedor</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
